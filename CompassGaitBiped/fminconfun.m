function [fx, yend] = fminconfun(u, x0, Qy, Qu, kimp, yref, params)
    ...
    %         dx = CWodefunInput(t,xk,u(i),m,a,mH,phi1,phi2);
            k1 = dt*CWodefunInput(xk,u(i),m,a,mH,phi1,phi2);
            k2 = dt*CWodefunInput(xk+k1/2,u(i),m,a,mH,phi1,phi2);
            k3 = dt*CWodefunInput(xk+k2/2,u(i),m,a,mH,phi1,phi2);
            k4 = dt*CWodefunInput(xk+k3,u(i),m,a,mH,phi1,phi2);
